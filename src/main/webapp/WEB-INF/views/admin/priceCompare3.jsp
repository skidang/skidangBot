...
<script src="<c:url value='/js/views/admin/admin3.js?v=20210103_474'/>"></script>
<script src="<c:url value='/js/views/common/compare.js?v=20210103_474'/>"></script>
...
<input type="hidden" class="form-control" id="audio1" value="y"/> 
<input type="hidden" class="form-control" id="audio2" value="y"/> 
<input type="hidden" class="form-control" id="audio3" value="y"/> 
    ...
    <div class="col-lg-3">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
            	<!-- <span class="label label-success pull-right">Monthly</span>  -->
                <h5>테더 계산</h5>
            		<input type="hidden" class="form-control" id="exchangePrice2" /> 
	            	<h5 class="no-margins" id="exchange_rate2"></h5>
	            	<span class="label label-info pull-right" id="exchangePriceUpdateDt2"></span>
             <div class="ibox-tools">
	            <a class="collapse-link">
	                <i class="fa fa-chevron-up"></i>
	            </a>
            ...
            <div class="ibox-content" style="display: none;">
               <div class="input-group">
	               	<input type="text" class="form-control" id="sathoshi2"> 
	               	<span class="input-group-btn"> 
	               		<button type="button" class="btn btn-primary" id="sathoshiBtn2" > 테더 계산</button> 
	               	</span>
            	</div>
            	<div class="form-group has-error">
            		<!-- <div class="form-group has-error"><label class="control-label"></label> -->
	            	<div class=""><input type="text" disabled="" id="sathoshiPrice2" class="form-control" /></div>
	            </div>
   			</div>
    	</div>
    </div>
  		...
  		<div class="col-lg-5">
           <div class="ibox float-e-margins">
               <div class="ibox-title">
                   ...
                   <div class="ibox-tools">
                   		<button type="button" onclick="javascript:audio_change('audio1', 'y');" class="btn btn-primary btn-xs">알람 ON</button>
                   		<button type="button" onclick="javascript:audio_change('audio1', 'n');" class="btn btn-primary btn-xs">알람 OFF</button> 
                       <a class="collapse-link">
                           <i class="fa fa-chevron-up"></i>
                       </a>
                       <a class="dropdown-toggle" data-toggle="dropdown" href="#">
    ...
    <div class="col-lg-6">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                   		<button type="button" onclick="javascript:audio_change('audio2', 'y');" class="btn btn-primary btn-xs">알람 ON</button>
                   		<button type="button" onclick="javascript:audio_change('audio2', 'n');" class="btn btn-primary btn-xs">알람 OFF</button> 
                        <a class="collapse-link">
                            <i class="fa fa-chevron-up"></i>
                        </a>
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
         ...
         <div class="col-lg-6">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                   		<button type="button" onclick="javascript:audio_change('audio3', 'y');" class="btn btn-primary btn-xs">알람 ON</button>
                   		<button type="button" onclick="javascript:audio_change('audio3', 'n');" class="btn btn-primary btn-xs">알람 OFF</button> 
                        <a class="collapse-link">
                            <i class="fa fa-chevron-up"></i>
                        </a>
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
